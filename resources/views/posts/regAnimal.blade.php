...
<form class="form-horizontal col-sm-12 " style="padding-top:5px">
    ...
    <div class="col-sm-3">        
        <button id="agregarFila" type="button" class="btn btn-success" style="margin-bottom:5px;margin-left: 12px">Agregar</button>                
        <button id="quitarFila" type="button" class="btn btn-danger" style="margin-bottom:5px;margin-left: 12px" >Eliminar</button>
    </div>          
    @include('posts.tabla') 
</form> 
@endsection
